...
// type QuestionFormConfigurationType = {
//   formId:string,
//   questionDetail:{
//     questionId:string
...
// const containerBasedDiv = (type: string) => {
//   switch (type) {
//     case "Single Choice":
//       return (
//         <div>
...
//       </div>
//       <div className=" w-full flex justify-center items-center gap-2">
//         <div className=" flex w-1/2 flex-row items-center justify-center border-dashed border-2 border-gray-400 px-4 py-4">
//           <Input
//             className=""
//             placeholder="Untitled Question"
//             onChange={(e) => e.target.value}
//           />
//           <Select onValueChange={setSelectedTypeOfQuestion} value={selectedTypeOfQuestion}>
...
//                  <>
//                    <SelectLabel key={ques.type}>{ques.type}</SelectLabel>
//                    {ques.useCases.map((u) => (
...
//         </div>
//         <div className=" ">
//           <PlusCircleIcon size={16} className="gap-1"/>
//         <CopyCheckIcon size={16}/>
//         </div>
//       </div>

//       <p>{selectedTypeOfQuestion}</p>
